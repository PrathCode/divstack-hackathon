    ...
    return (
        <div class="mainHomeDiv">
            ...
            <div class="homeDiv1">
                <div class="row" style={{margin: '0'}}>
                    <div class="col-lg-7" style={{padding: '0'}}>
                        <img class="mainimg" src="./images/homeimg.jpg" />
                    </div>
                    <div class="col-lg-5" style={{marginTop: '7%', padding: '0'}}>
                        ...
                        <button type="button" class="btn btn-secondary btn-lg mainheadbtn">Check Courses</button>
                    </div>
                </div>
            </div>
            ...
            <div class="homeDiv3">
                ...
                <img class="trendsimg" src="./images/trends.png" />
            </div>
